...
var p=0,i=true;if(u.push(n),o.push(t),a){if(l=n.length,p=t.length,(i=p==l)||e)for(;p--;)if(a=l,c=t[p],e){for(;a--&&!(i=At(n[a],c,r,e,u,o)););if(!i)break}else if(!(i=At(n[p],c,r,e,u,o)))break}else kt(t,function(t,a,l){return le.call(l,a)?(p++,i=le.call(n,a)&&At(n[a],t,r,e,u,o)):void 0}),i&&!e&&kt(n,function(n,t,r){return le.call(r,t)?i=-1<--p:void 0});return u.pop(),o.pop(),i}function St(n,t,r,e,u){(Fe(t)?V:Ot)(t,function(t,o){var i,a,l=t,f=n[o];if(t&&((a=Fe(t))||$e(t))){for(l=e.length;l--;)if(i=e[l]==t){f=u[l];
